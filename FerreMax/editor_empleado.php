...
<body>
    ...
    <div class="nav">
        <a href="catalogo.php">inventario</a>
    </div>
    ...
    $stmt = $enlace->prepare("INSERT INTO producto (producto_codigo, producto_nombre, producto_precio, producto_stock, producto_foto, categoria_id, usuario_id)
                              VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssdisii", $codigo, $nombre, $precio, $stock, $foto, $categoria_id, $usuario_id);
    $stmt->execute();

    $query = "SELECT producto_id, producto_codigo, producto_nombre, producto_precio, producto_stock, producto_foto, categoria_id, usuario_id FROM producto ORDER BY producto_id DESC";
    ...
    <label>Precio:</label>
    <input type="number" step="0.01" name="producto_precio" required>
    ...
    <label>Foto:</label>
    <input type="file" name="producto_foto" required>
